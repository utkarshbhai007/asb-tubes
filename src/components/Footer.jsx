      ...
      <div className="footer-bottom">
        <div className="container bottom-flex">
          ...
          <div className="social-links">
            <a href="https://www.facebook.com/ASB-TUBES-105792934569129" target="_blank" rel="noopener noreferrer" className="social-icon">FACEBOOK</a>
            <a href="https://www.instagram.com/asbtubes" target="_blank" rel="noopener noreferrer" className="social-icon">INSTAGRAM</a>
          </div>
        </div>
      </div>
