  ...
  return (
    <section id="contact" className="contact-section pattern-bg">
      <div className="container contact-grid">
        <div className="contact-info">
          ...
          <div className="info-item">
            ...
            <div>
              <h4>Head Office</h4>
              <p>504, Arizona Towers, Golden Park Society,<br />Usmanpura, Ahmedabad – 3800014,<br />Gujarat, INDIA.</p>
            </div>
          </div>
          <div className="info-item">
            <div className="info-icon">
          ...
          <div className="info-item">
            ...
            <div>
              ...
              <p style={{ display: 'flex', gap: '15px' }}>
                <a href="#" className="text-blue" aria-label="LinkedIn">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
                </a>
                <a href="https://www.facebook.com/ASB-TUBES-105792934569129" target="_blank" rel="noopener noreferrer" className="text-blue" aria-label="Facebook">
                ...
                <a href="https://www.instagram.com/asbtubes" target="_blank" rel="noopener noreferrer" className="text-blue" aria-label="Instagram">
      ...
      <div className="container" style={{ marginTop: '50px' }}>
        <div className="map-container" style={{ overflow: 'hidden', borderRadius: '12px', boxShadow: '0 10px 30px rgba(0,0,0,0.3)' }}>
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3661.0944626750406!2d72.40023459999999!3d23.420954599999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395c3f4ee6a5436b%3A0x7700cda2597f6cb6!2sASB%20Tubes%20Pvt%20Ltd!5e0!3m2!1sen!2sin!4v1714841558301!5m2!1sen!2sin"
            width="100%"
            height="400"
            style={{ border: 0 }}
            allowFullScreen=""
